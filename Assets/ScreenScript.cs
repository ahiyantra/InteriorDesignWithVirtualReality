...
public class ScreenScript : GazeableObjectScript
{

    public ScreenCameraTextureScript scts;
    ...
    public override void OnPress(RaycastHit hitInfo)
    {
        ...
        if (PlayerScript.instance.activeMode == InputMode.SCREENSWITCH)
        {

            scts.camPlay = !scts.camPlay;

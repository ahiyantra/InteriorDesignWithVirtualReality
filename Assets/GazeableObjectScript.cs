...
public class GazeableObjectScript : MonoBehaviour
{
    ...
    public virtual void OnGazeEnter(RaycastHit hitInfo)
    {
        ...
        if (isTransformable && (PlayerScript.instance.activeMode == InputMode.TRANSLATE || PlayerScript.instance.activeMode == InputMode.ROTATE || PlayerScript.instance.activeMode == InputMode.SCALE))
        {
    ...
    public virtual void GazeTransform(RaycastHit hitInfo)
    {
        ...
        switch (PlayerScript.instance.activeMode)
        {
